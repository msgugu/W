...
public class CharacterPref : MonoBehaviour
{
    ...
    public CharacterPref(float max_rotation_angle = 45.0f,
...
{
    void PopulateSaveData(CharacterPref a_SaveData);
    void LoadFromSaveData(CharacterPref a_SaveData);
}
